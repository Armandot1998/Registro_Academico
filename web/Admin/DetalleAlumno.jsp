                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"> 
                                                                            ...
                                                                            <div class="input-group margin-bottom-sm">
                                                                                ...
                                                                                <input class="form-control" name="txtNom1" type="text"  value="<%= rs.getString("primernombre_al")%>"  readonly="true"required="true">
                                                                            </div><br>
                                                                            <label>Segundo Nombre:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtNom2" type="text"  value="<%= rs.getString("segundonombre_al")%>" readonly="true" required="true">
                                                                            </div><br>
                                                                            <label>Primer Apellido:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtApe1" type="text" name="txtApe1" value="<%= rs.getString("primerapellido_al")%>"readonly="true"  required="true">
                                                                            </div><br>
                                                                            <label>Segundo Apellido:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtApe2" type="text" name="txtApe2" value="<%= rs.getString("segundoapellido_al")%>" readonly="true" required="true">
                                                                            </div><br>
                                                                            <label>Cédula de Identidad:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtCed" type="text" name="txtApe2" value="<%= rs.getString("cedula_al")%>" required="true" readonly="true" maxlength="10">
                                                                            </div><br>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"> 
                                                                            ...
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtCor" type="email"  value="<%= rs.getString("curso")%>" readonly="true" required="true">
                                                                            </div>                                                                              
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-1">
                                                                                    <a class="btn btn-default" href="Alumnos.jsp"><i class="fa fa-sign-out fa-lg"></i>&nbsp;Volver</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
