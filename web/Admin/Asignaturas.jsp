...
<html lang="es">
    ...
    <body>
        <%
            ...
            rs = smt.executeQuery("select  * from asignatura order by asignatura;");
            //Creamo la Tabla:     
        %>    
                                        ...
                                        <div class="container">
                                            <div class="">
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center"><h4>ASIGNATURAS</h4></th>
                                                            <th class="text-center"><h4>ESTADO - ASIGNATURA</h4></th>
                                                        ...
                                                        <tbody id="tbodys">
                                                            ...
                                                            %>
                                                            <tr><form>
                                                            <td class="text-center"> <input type="text"  name="txtAsi" readonly="true" class="form-control" value="<%= rs.getString("asignatura")%>"/></td>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="EditAsignatura.jsp?id='<%=rs.getString("asignatura")%>'" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"></i> Editar</a>
                                                        </td>
                                                        </tr>
                                                        <%}%>
                                                </table>
        ...
        <%  String estado, asignatura, estado1, asignatura1;

            estado = request.getParameter("txtEst");
            asignatura1 = request.getParameter("txtNom");
            asignatura = request.getParameter("txtAsi");
            estado1 = "Activo";

            if (estado != null && asignatura != null) {
                ps = con.prepareStatement("update asignatura set estado='" + estado + "' where asignatura='" + asignatura + "';");
                ps.executeUpdate();
    ...
    <div class="container">          
            ...
            <div class="modal-dialog" role="document" style="z-index: 9999; width: 450px">
                <div class="modal-content">
                    <div class="modal-header">                            
                        <h4 class="modal-title" id="myModalLabel">Registrar nueva Asignatura</h4>
                    </div>
        ...
        <%
            if (asignatura1 != null && estado1 != null) {
                ps = con.prepareStatement("insert into asignatura values ( '" + asignatura1 + "', '" + estado1 + "');");
                ps.executeUpdate();
                response.sendRedirect("Asignaturas.jsp");
            }
        %>
