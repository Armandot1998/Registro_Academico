...
<html lang="es">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"> 
                                                                            ...
                                                                            <div class="input-group margin-bottom-sm">
                                                                                ...
                                                                                <input class="form-control" name="txtNom1" type="text"  value="<%= rs.getString("primernombre_us")%>" required="true">
                                                                            </div><br>
                                                                            <label>Segundo Nombre:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtNom2" type="text"  value="<%= rs.getString("segundonombre_us")%>" required="true">
                                                                            </div><br>
                                                                            <label>Primer Apellido:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtApe1" type="text" name="txtApe1" value="<%= rs.getString("primerapellido_us")%>" required="true">
                                                                            </div><br>
                                                                            <label>Segundo Apellido:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtApe2" type="text" name="txtApe2" value="<%= rs.getString("segundoapellido_us")%>" required="true">
                                                                            </div><br>
                                                                            <label>Cédula de Identidad:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtCed" type="text" name="txtApe2" value="<%= rs.getString("cedula_us")%>" required="true" maxlength="10">
                                                                            </div><br>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group"> 
                                                                            ...
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtCor" type="email"  value="<%= rs.getString("correo_us")%>" required="true">
                                                                            </div><br>
                                                                            <label>Nombre de Usuario:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtUse" type="text"  value="<%= rs.getString("username_us")%>" required="true">
                                                                            </div><br>
                                                                            <label>Clave de Ingreso:</label> 
                                                                            <div class="input-group margin-bottom-sm">
                                                                                <span class="input-group-addon"><i class="fa fa-user-circle fa-fw"></i></span>
                                                                                <input class="form-control" name="txtCla" type="text" name="txtApe1" value="<%= rs.getString("clave_us")%>" required="true">
                                                                            </div><br>                                                                                  
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-1">
                                                                                    <a class="btn btn-default" href="Docentes.jsp"><i class="fa fa-sign-out fa-lg"></i>&nbsp;Cancelar</a>                                                                                   
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    <%  String nombre1, nombre2, apellido1, apellido2, cedula, correo, username, contra;
        ...
        if (nombre1 != null && nombre2 != null && apellido1 != null && apellido2 != null && cedula != null && correo != null && username != null && contra != null) {
            ps = con.prepareStatement("update usuario set primernombre_us='" + nombre1 + "', segundonombre_us='" + nombre2 + "', primerapellido_us='" + apellido1 + "', segundoapellido_us='" + apellido2 + "', cedula_us='" + cedula + "',correo_us='" + correo + "',username_us='" + username + "', clave_us='" + contra + "' where cedula_us='" + cedula + "';");
            ps.executeUpdate();
